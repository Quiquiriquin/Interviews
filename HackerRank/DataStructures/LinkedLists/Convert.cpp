...
void convert(string, int, int,int,int);
...
int main(){
 ...
 for(int i = 1; i <= numero;i++){
  convert(binario, resto, divisor,dividendo,i);
 }
}

void convert(string binario, int resto, int divisor, int dividendo, int numero){
   dividendo = numero;
